...
const NAV_LINKS = [
  { title: "Beranda", url: "/super-admin" },
  { title: "Masyarakat", url: "/super-admin/masyarakat" },
  { title: "Bank Sampah", url: "/super-admin/admin" },
  { title: "Edukasi", url: "/super-admin/edukasi" },
  { title: "Pengaturan", url: "/super-admin/settings" },
];
    ...
    <header className="grid w-full grid-cols-4 items-center justify-between rounded-2xl px-2 py-3 max-md:hidden">
      ...
      <div className="flex items-center justify-end gap-1.5">
        ...
        <div className="bg-card flex items-center gap-2 rounded-full px-2 py-1">
          <div className="bg-primary text-primary-foreground flex size-10 items-center justify-center rounded-full text-xs font-semibold">
            SA
          </div>
          <div className="flex flex-col leading-tight">
            <span className="text-sm font-semibold">Super Admin</span>
            <span className="text-muted-foreground text-xs">SUPER_ADMIN</span>
          </div>
