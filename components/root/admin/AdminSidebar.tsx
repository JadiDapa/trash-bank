...
const menuItems = [
  ...
  { title: "Tiket Deposit", url: "/admin/tiket/deposit", icon: Trash2 },
  { title: "Tiket Voucher", url: "/admin/tiket/voucher", icon: Gift },
];
...
export default function AdminSidebar({ initials }: Props) {
